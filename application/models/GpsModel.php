...
class GpsModel extends CI_Model {
    ...
    public function serviceableDashboard()
    {
        $data = $this->db->query("SELECT gps_type.gps_type_id, gps_type.gps_type_name, gps_purchase_order, gps_imei_number, gps_sn, vendor_id, gps.gps_type_id, gps_cond_id, gps_stat_id, 
                                gps_received_date, gps_received_by, status, gps_information, gps_qty, count(gps_qty) AS stock 
                                FROM gps 
                                JOIN gps_type ON gps.gps_type_id=gps_type.gps_type_id
                                WHERE status='Received' AND gps_cond_id=1
                                GROUP BY gps_purchase_order, gps_imei_number, gps_sn, vendor_id, gps_type.gps_type_id, gps.gps_type_id, gps_type_name, gps_cond_id, gps_stat_id, 
                                gps_received_date, gps_received_by, status, gps_information, gps_qty");
        return $data;
    }

    public function unserviceableDashboard()
    {
        $data = $this->db->query("SELECT gps_type.gps_type_id, gps_type.gps_type_name, gps_purchase_order, gps_imei_number, gps_sn, vendor_id, gps.gps_type_id, gps_cond_id, gps_stat_id, 
                                gps_received_date, gps_received_by, status, gps_information, gps_qty, count(gps_qty) AS stock 
                                FROM gps 
                                JOIN gps_type ON gps.gps_type_id=gps_type.gps_type_id
                                WHERE status='Received' AND gps_cond_id=2
                                GROUP BY gps_purchase_order, gps_imei_number, gps_sn, vendor_id, gps_type.gps_type_id, gps.gps_type_id, gps_type_name, gps_cond_id, gps_stat_id, 
                                gps_received_date, gps_received_by, status, gps_information, gps_qty");
        return $data;
    }
