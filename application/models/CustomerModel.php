...
class CustomerModel extends CI_Model {
    ...
    public function activeCustPersonDashboard()
    {
        $data = $this->db->query("SELECT customer_religion.cust_religion_id, customer_religion.cust_religion_name,
                                ...
                                customer_personal.cust_start_date_contract, customer_personal.cust_end_date_contract, customer_personal.cust_personal_insert, 
                                customer_personal.cust_personal_update, customer_personal.cust_personal_user, customer_personal.status, 
                                count(customer_personal.cust_name) as stock 
                                ...
                                where customer_personal.cust_type_id=1 AND customer_personal.status='Active'
                                group by customer_personal.cust_personal_id, customer_personal.cust_code, customer_personal.cust_name, 
                                customer_personal.cust_birth_date, customer_personal.cust_type_id, customer_type.cust_type_id, customer_type.cust_type_name, customer_personal.cust_gender, 
                                customer_personal.cust_religion_id, customer_religion.cust_religion_id, customer_religion.cust_religion_name, customer_personal.cust_personal_email,
                                customer_personal.cust_personal_phone, customer_personal.cust_personal_mobile_phone, customer_personal.cust_personal_address, 
                                customer_personal.cust_start_date_contract, customer_personal.cust_end_date_contract, customer_personal.status");
        return $data;
    }

    public function notActiveCustPersonDashboard()
    {
        $data = $this->db->query("SELECT customer_religion.cust_religion_id, customer_religion.cust_religion_name,
                                customer_type.cust_type_id, customer_type.cust_type_name,
                                ...
                                JOIN customer_religion ON customer_personal.cust_religion_id=customer_religion.cust_religion_id
                                JOIN customer_type ON customer_personal.cust_type_id=customer_type.cust_type_id
                                where customer_personal.cust_type_id=1 AND customer_personal.status='Not Active'
                                group by customer_personal.cust_personal_id, customer_personal.cust_code, customer_personal.cust_name, 
                                customer_personal.cust_birth_date, customer_personal.cust_type_id, customer_type.cust_type_id, customer_type.cust_type_name, customer_personal.cust_gender, 
                                customer_personal.cust_religion_id, customer_religion.cust_religion_id, customer_religion.cust_religion_name, customer_personal.cust_personal_email,
                                customer_personal.cust_personal_phone, customer_personal.cust_personal_mobile_phone, customer_personal.cust_personal_address, 
    ...
    public function activeCustCompDashboard()
    {
        $data = $this->db->query("SELECT customer_business_type.cust_business_type_id, customer_business_type.cust_business_type_name,
                                
                                customer_type.cust_type_id, customer_type.cust_type_name,
                                
                                customers_pic_contact.cust_name, customers_pic_contact.cust_position, customers_pic_contact.cust_department,
                                customers_pic_contact.cust_mobile_phone, customers_pic_contact.cust_email, customers_pic_contact.cust_religion_id,
                                customers_pic_contact.cust_birth_date, customers_pic_contact.cust_address,

                                customer_company.cust_company_id, customer_company.cust_code, customer_company.status, customer_company.cust_company_name, customer_company.cust_type_id, customer_company.cust_business_type, customer_company.cust_pic_contact, customer_company.cust_company_phone, 
                                customer_company.cust_company_email, customer_company.cust_company_address, customer_company.status, customer_company.cust_start_date_contract, customer_company.cust_end_date_contract, customer_company.cust_company_insert, 
                                customer_company.cust_company_update, customer_company.cust_company_user, 
                                count(customer_company.cust_company_name) as stock 
                                from customer_company
                                JOIN customer_business_type ON customer_company.cust_business_type=customer_business_type.cust_business_type_id
                                JOIN customers_pic_contact ON customer_company.cust_pic_contact=customers_pic_contact.cust_pic_contact_id
                                JOIN customer_type ON customer_company.cust_type_id=customer_type.cust_type_id
                                where customer_company.cust_type_id=2 AND customer_company.status='Active'
                                group by customer_business_type.cust_business_type_id, customer_business_type.cust_business_type_name,
    ...
    public function notActiveCustCompDashboard()
    {
        $data = $this->db->query("SELECT customer_business_type.cust_business_type_id, customer_business_type.cust_business_type_name,
                                ...
                                JOIN customers_pic_contact ON customer_company.cust_pic_contact=customers_pic_contact.cust_pic_contact_id
                                JOIN customer_type ON customer_company.cust_type_id=customer_type.cust_type_id
                                where customer_company.cust_type_id=2 AND customer_company.status='Not Active'
                                group by customer_business_type.cust_business_type_id, customer_business_type.cust_business_type_name,
