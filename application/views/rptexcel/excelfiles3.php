...
$worksheet1->write_string(0,4,'GSM Disable Date',$header);  // Set Nama kolom
$worksheet1->set_column(0,4,15); // Set lebar kolom
$worksheet1->write_string(0,5,'GSM Disable By',$header);  // Set Nama kolom
...
foreach ($data as $key) {
    ...
    $worksheet1->write_string($row,4,  $key->gsm_disable_date ,$content);
    $worksheet1->write_string($row,5,  $key->gsm_disable_by ,$content);
    $row++;
}
