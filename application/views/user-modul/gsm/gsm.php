                    ...
                    <a href="<?php //echo base_url('gsm/excelfiles'); ?>">
                        ...
                        <div class="responsive-table">
                         <form method="post" action="<?php echo base_url('gsm/activeAll'); ?>">
                            ...
                            <thead>
                              <tr>
                                <!--<th><center><input type="checkbox" class="icheck" id="checkAll" /></center></th>-->
                                <th>No</th>
                                <th>GSM Number</th>
                            ...
                            ?>
                              <tr>
                                <!--<td><center><input type="checkbox" name="check_id[]" value="<?php //echo $v->gsm_id ?>" class="checkthis icheck" /></center></td>
                                --><td><?php echo $no; ?></td>
                            ...
                            ?>
                                ...
                                <!--<input type="submit" value="Activate" class="btn btn-sm btn-raised btn-success">-->    
                            </form>
