            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-9">
                        <h3 class="animated fadeInLeft">Data All GSM Activated</h3>
                        <p class="animated fadeInDown">
                            <a href="<?php echo base_url('dashboard'); ?>">CSIS</a> <span class="fa-angle-right fa"></span> GSM Activated
                        </p>
                    </div>
            ...
            <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="col-md-6">
                    <div class="panel">
                      <div class="panel-heading-white panel-heading">
                        <h4>Chart Stock GSM Activated</h4>
                      </div>
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div id="chartGsmActivated"></div>                            
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="panel">
                      <div class="panel-heading-white panel-heading">
                        <h4>Table Stock GSM Activated</h4>
                      </div>
