            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-9">
                        <h3 class="animated fadeInLeft">Data All GSM Disable</h3>
                        <p class="animated fadeInDown">
                            <a href="<?php echo base_url('dashboard'); ?>">CSIS</a> <span class="fa-angle-right fa"></span> GSM Disable
                        </p>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="panel">
                      <div class="panel-heading-white panel-heading">
                        <h4>Chart Stock GSM Disable</h4>
                      </div>
                      <div class="panel-body">
                        <div class="col-md-12">
                          <div id="chartGsmDisable"></div>                            
                        </div>
                      </div>
                    </div>
                  </div>
