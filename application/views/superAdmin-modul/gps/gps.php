    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">GPS Recieved</h3>
            ...
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="well">
                            <!--<div class="col-md-9">-->
                                <!--<a href="#" class="btn btn-raised btn-primary btn-sm" data-toggle="modal" data-target="#myModal">
                    ...
                    <div class="responsive-table">
                        <table id="datatables-example-gps" class="table table-striped table-bordered" width="100%" cellspacing="0">
                        <thead>
                          <tr>
                            <th>No</th>
                            <th>PO</th>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $v->gps_date_check;?></td>
