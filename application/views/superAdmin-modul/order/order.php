    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Data Installation</h3>
            ...
            <div class="panel">
                ...
                <button class="btn btn-primary btn-xs" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                    ...
                    <div class="responsive-table">
                        <table id="datatables-example-install" class="table table-striped table-bordered" width="100%" cellspacing="0">
                        <thead>
                          <tr>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="javascript:void(0)" onclick="add_order('<?php echo $v->odet_id; ?>','<?php echo $v->veh_install_type_business; ?>')" class="btn btn-xs btn-info"data-toggle="tooltip" data-placement="right" title="Add Data"><span ><i class="fa fa-plus"></i></span> </a>
                                        
                                        <a href="javascript:void(0)" onclick="detail_order('<?php echo $v->odet_id; ?>')" class="btn btn-xs btn-default"data-toggle="tooltip" data-placement="right" title="Read Data"><span ><i class="glyphicon glyphicon-list-alt"></i></span> </a>
                                        
                                        <a href="javascript:void(0)" onclick="uninstall_order('<?php echo $v->odet_id; ?>')" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="left" title="Uninstall GPS"><span ><i class="fa fa-gear"></i></span> </a>
                                    </center>
                                </td>
                            </tr>
                        <?php
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#po" data-toggle="tab">PO Installation</a></li> 
                    <li><a href="#trial" data-toggle="tab">Trial Installation</a></li>
                </ul>
                ...
                <div class="tab-pane active" id="po">
                    ...
                    <form id="form" method="post" action="<?php echo base_url('order/process_order_install'); ?>" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Vehicle Name <b>*</b></label>
                                    <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Vehicle Number Police <b>*</b></label>
                                    <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Vehicle Number Lambung <b>*</b></label>
                                    <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Vehicle Remarks <b>*</b></label>
                                    <div class="col-md-9">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="tab-pane active" id="po">
                    ...
                    <!--<form id="form" action="<?php echo base_url('order/process_order_install'); ?>" class="form-horizontal">-->
                    ...
                    <div class="modal-body form">
                            <div class="form-group">
                                <label class="control-label col-md-3">Number Type</label>
                                <div class="col-md-9">
                                    <div class="radio">
                                        <label class="radio-inline">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="order_number" placeholder="Type here for number of BAST or SPK" class="form-control">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <!--<button type="submit" id="sbtSave" onclick="#sbtSave" name="save" class="btn btn-primary" >Save</button>
                        <button type="submit" id="sbtSave2" onclick="#sbtSave2" class="btn btn-primary">Save & New</button>-->
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                    </form>
                    <?php //echo form_close(); ?>
                ...
                <div class="tab-pane" id="trial">
                    ...
                    <?php echo form_open('order/process_order_install_trial'); ?>
                        <form id="form" action="<?php echo base_url('order/process_order_install'); ?>" class="form-horizontal">
                            <?php echo validation_errors(); ?>
                    ...
                    <div class="modal-body form">
                    <!--<form action="#" id="form_trial" class="form-horizontal">-->
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="save" class="btn btn-primary" >Save</button>
                        <!--<button type="submit" id="trialSave" onclick="#trialSave" name="save" class="btn btn-primary" >Save</button>
                        <button type="button" id="trialSave2" onclick="#trialSave2" class="btn btn-primary">Save & New</button>-->
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                    <?php echo form_close(); ?>
...
<!---########################################################### Modal Jquery Add Order In One BAST Type 1 ################################################################## -->
<div class="modal fade" id="modal_edit" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Form PO Installation</h3>
            </div>
            <form method="post" action="<?php echo base_url('order/ajax_po_install'); ?>" class="form-horizontal">
                <div class="modal-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Type Number <b>*</b></label>
                                <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="emp_id_edit" required>
                                    <?php
                                        echo '<option value="" selected="selected" disabled="" required>--- Choose Technicion ---</option>';
                                        $showemp=pg_query("SELECT * FROM employee WHERE pos_id = '1' Order By emp_name Desc");
                                            while ($emp=pg_fetch_array($showemp)) {
                                            echo "<option value=$emp[emp_id]>$emp[emp_name]</option>";
                                        }
                                    ?>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Vehicle Name <b>*</b></label>
                            <div class="col-md-9">
                                <input name="order_veh_name_edit" placeholder="Vehicle Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Vehicle Number Police <b>*</b></label>
                            <div class="col-md-9">
                                <input name="order_veh_num_police_edit" placeholder="Vehicle Number Police" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Vehicle Number Lambung <b>*</b></label>
                            <div class="col-md-9">
                                <input name="order_veh_num_flank_edit" placeholder="Vehicle Number Lambung" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Vehicle Remarks <b>*</b></label>
                            <div class="col-md-9">
                                <textarea name="order_veh_remarks_edit" placeholder="Keterangan" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
...
<!---########################################################### End Modal Jquery Add Order In One BAST  Type 1 ################################################################## -->

<!---########################################################### Modal Jquery Add Order In One BAST Type 2 ################################################################## -->
<div class="modal fade" id="modal_edit_trial" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Form Trial Installation</h3>
            </div>
...
<!---########################################################### End Modal Jquery Add Order In One BAST Type 2 ################################################################## -->
...
<script type="text/javascript">
    ...
    function add()
    {
        ...
        $('.modal-title').text('Purchase Order Installation'); // Set Title to Bootstrap modal title
        $('.modal-title-trial').text('Trial Installation')
    }

    /////////////////////////////////////////////// Modal Jquery Add Order In One BAST ///////////////////////////////////////////////////////
    function add_order(id,type)
    {
        $('.help-block').empty(); // clear error string

        //Ajax Load data from ajax
        $.ajax({
            url : "<?php echo site_url('order/ajax_add/')?>/" + id + '/' + type,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                else if(type==2)
                {
                    ...
                    $('#modal_edit_trial').modal('show'); // show bootstrap modal when complete loaded
                }
    ...
    /////////////////////////////////////////////// End Modal Jquery Add Order In One BAST ///////////////////////////////////////////////////////
    ...
    function detail_order(id)
    {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url : "<?php echo site_url('order/ajax_detail/')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                //$('.detail_veh_install_type_business').html(data.veh_install_type_business);
    ...
    /////////////////////////////////////////////// Modal Jquery Uninstall ///////////////////////////////////////////////////////
    function uninstall_order(id)
    {
        $('.help-block').empty(); // clear error string

        //Ajax Load data from ajax
        $.ajax({
            url : "<?php echo site_url('order/ajax_uninstall/')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
