    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Vendor</h3>
            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
						...
						<!--<button class="btn btn-primary btn-xs collapsed" type="button" data-toggle="collapse" data-target="#collapseFilter" aria-expanded="false" aria-controls="collapseExample">
                            <span data-toggle="tooltip" data-placement="right" title="Collapse for Action">Filter</span>
                        </button>-->
						...
						<div style="height: 0px;" aria-expanded="false" class="collapse" id="collapseFilter">
                            <div class="well">
                                <form action="<?php echo base_url('vendor/search'); ?>" class="login-wrapper" method="get">
								<div class="col-md-7">
                                    <div class="form-group">
										<label class="control-label col-md-3"><b>Nama Vendor</b></label>
										<div class="col-md-7">
											<input name="search" placeholder="Vendor Name" class="form-control" type="text">
											<span class="help-block"></span>
										</div>
										
									</div>
                                </div>
								<!--<a href="<?php echo base_url('vendor/excel_vendor'); ?>" style="margin-left: 17%;">
									<button type="button" class="btn  btn-sm btn-raised btn-primary">
										<i class="fa fa-search"> Search</i>
									</button>-->
									<input class="btn  btn-sm btn-raised btn-primary" style="margin-left: 17%;" type="submit" name="sub" value="search now">
								</form>
								<!--</a>-->
							</div>
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="responsive-table">
                            <table id="datatables-example-vendor" class="table table-striped table-bordered" width="100%" cellspacing="0">
                            <thead>
                              <tr>
                                <th>No</th>
                                <th>Nama Vendor</th>
