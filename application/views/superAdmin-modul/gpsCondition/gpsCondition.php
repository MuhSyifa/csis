    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Data All GPS Condition</h3>
                        <p class="animated fadeInDown">
                            <a href="<?php echo base_url('dashboard'); ?>">CSIS</a> <span class="fa-angle-right fa"></span> <a href="<?php echo base_url('gps/gps_list'); ?>">GPS</a> <span class="fa-angle-right fa"></span> Data All GPS Condition
                        </p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="modal-body form">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama Condition</label>
                            <div class="col-md-9">
