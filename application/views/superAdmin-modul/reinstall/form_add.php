    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Form PO Reinstallation</h3>
                        <p class="animated fadeInDown">
                            <a href="<?= base_url('dashboard');?>">CSIS</a> <span class="fa-angle-right fa"> </span>
                            <a href="<?php echo base_url('reinstall/reinstall_list'); ?>">Reinstallation</a> <span class="fa-angle-right fa"></span> Form Po Reinstallation
                        </p>
                    </div>
                    <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="veh_id">
                                        <?php
                                          echo '<option value="" selected="selected" disabled="" required>--- Choose Vehicle ---</option>';
                                            $showgps=pg_query("SELECT * FROM Tablevehicles Where status = 'Uninstalled' ");
