    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Form Trial Reinstallation</h3>
                        <p class="animated fadeInDown">
                            <a href="<?= base_url('dashboard');?>">CSIS</a> <span class="fa-angle-right fa"> </span>
                            <a href="<?php echo base_url('reinstall/reinstall_list'); ?>">Reinstallation</a> <span class="fa-angle-right fa"></span> Form Trial Reinstallation
                        </p>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-12 padding-0">
                <div class="col-md-12">
                        ...
                        <?php echo validation_errors(); ?>
                            ...
                            <!--<div class="form-group">
                                <label class=""><b>Vehicle Install Type</b></label>
                                    <input type="text" name="vehicle_install_type" placeholder="Vehicle Number" value="<?php echo $data->veh_install_type_business;?>"  class="form-control" required disabled>
                            </div>-->
                                    ...
                                    <select class="form-control" name="veh_id">
                                        <?php
                                          echo '<option value="" selected="selected" disabled="" required>--- Choose Vehicle ---</option>';
                                            $showgps=pg_query("SELECT * FROM vehicles Where status = 'Uninstalled' ");
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= base_url('reinstall/reinstall_list');?>" class="btn btn-default" type="button">Cancel</a>
                    </div>
                <?php echo form_close(); ?>
                    </div>
                </div>
