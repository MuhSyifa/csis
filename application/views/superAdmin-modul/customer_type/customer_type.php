                        ...
                        <div class="responsive-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" onclick="edit_cust_type('<?php echo $v->cust_type_id; ?>')" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i></a> 
                                        <a href="javascript:void(0)" onclick="delete_cust_type('<?php echo $v->cust_type_id; ?>')" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="right" title="Delete Data"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
                                </tr>
                                <?php
                                    $no++;
...
<!---########################################################### Modal Jquery Edit Customer Type ################################################################## -->
<div class="modal fade" id="modal_edit" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title">Form Edit Customer Type</h3>
            </div>
            <form method="post" action="<?php echo base_url('customer_type/ajax_update'); ?>" class="form-horizontal">
                <div class="modal-body form">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="cust_type_name_edit" placeholder="Customer Type Name" class="form-control" type="text">
...
<!---########################################################### End Modal Jquery Edit Customer Type ################################################################## -->
...
<script type="text/javascript">
    /////////////////////////////////////////////// Modal Jquery Edit Customer Type ///////////////////////////////////////////////////////
    function edit_cust_type(id)
    {
        $('.help-block').empty(); // clear error string

        //Ajax Load data from ajax
        $.ajax({
            url : "<?php echo site_url('customer_type/ajax_edit/')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                $('[name="id"]').val(data.cust_type_id);
                $('[name="cust_type_name_edit"]').val(data.cust_type_name);
    ...
    /////////////////////////////////////////////// Start Modal Jquery Proses Delet Customer Type ///////////////////////////////////////////////////////
    function delete_cust_type(id)
    {
        if(confirm('Are you sure delete this data?'))
        {
            // ajax delete data to database
            $.ajax({
                url : "<?php echo site_url('customer_type/ajax_delete')?>/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {                    
    ...
    /////////////////////////////////////////////// End Modal Jquery Proses Delet Customer Type ///////////////////////////////////////////////////////
</script>