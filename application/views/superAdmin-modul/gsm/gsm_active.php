    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">GSM Card Activated</h3>
                        <p class="animated fadeInDown">
                            <a href="<?php echo base_url('dashboard'); ?>">CSIS</a> <span class="fa-angle-right fa"></span> <a href="<?php echo base_url('gsm/gsm_list'); ?>">GSM</a> <span class="fa-angle-right fa"></span> GSM Card Activated
                        </p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="responsive-table">
                            <table id="datatables-example-gsm-active" class="table table-striped table-bordered" width="100%" cellspacing="0">
                            <thead>
                              <tr>
                                <th>No</th>
                                <th>GSM Number</th>
                            ...
                            ?>
                              <tr>
                                ...
                                <td><i class="label label-success"><?php echo $v->status; ?></i></td>
                                <td>
                                    <a href="javascript:void(0)" onclick="detail_gsm_active('<?php echo $v->gsm_id ?>')" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="right" title="Detail Data"><i class="glyphicon glyphicon-list-alt"></i></a>
                                    <a href="javascript:void(0)" onclick="gsm_disable('<?php echo $v->gsm_id ?>')" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="right" title="Disable Data"><i class="fa fa-edit"></i></a>
                                    <!--<a href="detail/<?php //echo $v->gsm_id ?>" id="btnView" class="btn btn-xs btn-info" style="width: 45%;"><i style="margin-left: -13px;" class="fa fa-edit"></i> Detail</a>-->
                                </td>
                              </tr>
                            <?php 
                                $no++; 
