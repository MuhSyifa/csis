    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">GSM Card Received</h3>
                        <p class="animated fadeInDown">
                            <a href="<?php echo base_url('dashboard'); ?>">CSIS</a> <span class="fa-angle-right fa"></span> <a href="">GSM</a> <span class="fa-angle-right fa"></span> GSM Card Received
                        </p>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="panel-body">
                        <div class="responsive-table">
                         <form method="post" action="<?php echo base_url('gsm/activeAll'); ?>">
                            <table id="datatables-example-gsm" class="table table-striped table-bordered" width="100%" cellspacing="0">
                            <thead>
                              <tr>
                    ...
                    <div class="modal-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3">Number Card GSM</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Number IMSI GSM</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Number ICCID GSM</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">GSM Received Date</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">GSM Received By</label>
                                <div class="col-md-9">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3">GSM Activated Date</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">GSM Activated By</label>
                                <div class="col-md-9">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?= validation_errors(); ?>
                        ...
                        <div class="modal-footer">
                            <input name="submit" class="btn btn-primary" value="Save" type="submit">
