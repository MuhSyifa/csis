                  ...
                  <div class="col-md-6">
                    <h3 class="animated fadeInLeft">Form Edit Vehicle</h3>
                      <p class="animated fadeInDown">
                        <a href="<?php echo base_url('dashboard'); ?>">CSIS</a> <span class="fa-angle-right fa"></span> <a href="<?php echo base_url('vehicle/vehicle_list'); ?>">Data All Vehicle</a> <span class="fa-angle-right fa"></span> Form Edit Vehicle
                      </p>
                  </div>
                  <div class="col-md-6">
