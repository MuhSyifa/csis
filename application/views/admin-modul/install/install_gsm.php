    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Data Gsm Install</h3>
                        ...
                        <div class="responsive-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php //echo base_url(); ?>install/read_gsm/<?php //echo $v->gsm_id; ?>" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="right" title="Detail Data"><i class="glyphicon glyphicon-list-alt"></i> </a>
                                    </td>
                                </tr>
                                <?php
                                    $no++;
