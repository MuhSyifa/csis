    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Data Gps Install</h3>
                        <p class="animated fadeInDown">
                            <a href="<?= base_url('dashboard');?>">CSIS</a> <span class="fa-angle-right fa"></span> <a href="<?= base_url('employee/employee_list');?>">Employee</a> <span class="fa-angle-right fa"></span> Data Gps Install
                        </p>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="responsive-table">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>IMEi Number Gps</th>
                                    <th>Serial Number Gps</th>
                                    <th>Status</th>
                            ...
                            <tbody>
                                <?php 
                                    $no = 1;
                                        foreach ($install_gps as $v):
                                ?>
                                <tr>
                                    <td align="center"><?= $no; ?></td>
                                    <td><?php echo $v->no_purchase_order; ?></td>
                                    <td><?php echo $v->gps_imei_number; ?></td>
                                    <td><?php echo $v->gps_sn; ?></td>
                                    <td><?php echo $v->status; ?></td>
                                    <td>
                                        <a href="<?php echo base_url(); ?>uninstall/read/<?php echo $v->gps_id; ?>" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="right" title="Detail Data"><i class="glyphicon glyphicon-list-alt"></i> </a>
                                    </td>
                                </tr>
                                <?php
                                    $no++;
