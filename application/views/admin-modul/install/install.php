                    ...
                    <div class="responsive-table">
                        ...
                        ?>
                            <tr>
                                <td><?= $no; ?></td>
                                <td><?= $v->ins_number; ?></td>
                                <td><input type="hidden" name="is_vehicles[]" value="<?php echo $v->is_vehicles;?>" /><?php echo $v->is_vehicles;?></td>
                                <td><input type="hidden" name="is_gps[]" value="<?php echo $v->is_gps;?>" /><?php echo $v->ins_location;?></td>
                                <td><input type="hidden" name="is_employees[]" value="<?php echo $v->is_employees;?>" /><?php echo $v->is_employees;?></td>
                                <td><?= $v->ins_date; ?></td>
                                <td><input type="hidden" name="is_customer[]" value="<?php echo $v->is_customer;?>" /><?php echo $v->is_customer;?></td>
                                <td>
                                    <center>
                        ...
                        <?php echo validation_errors(); ?>
                            ...
                            <div class="form-group">
                                <label class=""><b>Date Installation</b></label>
                                    <input type="text" name="ins_date" placeholder="17, August 1945"  class="form-control date" id="datepicker" required>
                            </div>
                </div>
