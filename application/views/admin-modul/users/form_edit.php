                    ...
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Form Edit User</h3>
                            <p class="animated fadeInDown">
                                <a href="<?php echo base_url('dashboard'); ?>">Dashboard</a> <span class="fa-angle-right fa"></span> <a href="<?php echo base_url('users/user_list'); ?>">Data User</a> <span class="fa-angle-right fa"></span> Form Edit User
                            </p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="panel form-element-padding">
                        ...
                        <?php echo validation_errors(); ?>
                          ...
                          <div class="form-controll">
                            <button type="submit" name="submit" class="btn btn-Succecss">Save</button>
                          </div>
                        <?php echo form_close(); ?>
                        <!-- </form> -->
                        </div>
