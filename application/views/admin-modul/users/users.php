                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        ...
                        <p class="animated fadeInDown">
                            <a href="<?= base_url('dashboard');?>">Dashboard</a> <span class="fa-angle-right fa"></span> <a href="<?= base_url('users/user_list');?>">User's Management</a> <span class="fa-angle-right fa"></span> Data Users
                        </p>
                    </div>
                    <div class="col-md-6">
    ...
    <div class="col-md-12 top-20 padding-0">
        <div class="col-md-12">
            <div class="panel">
                ...
                <!-- <a href="<?php //echo base_url('index.php/vendor/add'); ?>" class="btn btn-raised btn-xs btn-primary">
                <i class="glyphicon glyphicon-plus"></i> Add Data</a> -->
                
                <!-- <a href="#" data-toggle="modal" class="btn btn-sm btn-raised btn-success" data-target="#login-modal">
                <i class="fa fa-file-excel-o"> Import</i></a> -->
                </div>
                    <div class="panel-body">
                    <div class="responsive-table">
                        ...
                        <?php 
                          ...
                          <tr>
                            ...
                            <td align="center" >
                                <a href="<?= base_url()?>users/update/<?= $v->user_id ?>" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i> Edit</a> 
                                <a href="javascript:if(confirm('Are you sure to delete this data???')){document.location='<?= base_url();?>users/process_delete/<?= $v->user_id; ?>';}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-trash"></i> Delete</a>
                            </td>
                          </tr>
                        <?php 
                            $no++; 
