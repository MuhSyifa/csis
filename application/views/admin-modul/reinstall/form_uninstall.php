                  ...
                  <div class="col-md-6">
                    <h3 class="animated fadeInLeft">Form Uninstallation</h3>
                        <p class="animated fadeInDown">
                            ...
                            <a href="<?php echo base_url('reinstall/reinstall_list'); ?>">Reinstallation</a> <span class="fa-angle-right fa"></span> Form Uninstallation
                        </p>
                  </div>
                  <div class="col-md-6">
            ...
            <div class="col-md-12 padding-0">
                <div class="col-md-12">
                    <div class="panel form-element-padding">
                        ...
                        <?php echo form_open('reinstall/process_order_uninstall'); ?>
