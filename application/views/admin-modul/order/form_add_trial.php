    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <h3 class="animated fadeInLeft">Form Trial Installation</h3>
                        <p class="animated fadeInDown">
                            <a href="<?php echo base_url('dashboard'); ?>">CSIS</a> <span class="fa-angle-right fa"></span>
                            <a href="<?php echo base_url('order/order_list'); ?>">Installation</a> <span class="fa-angle-right fa"></span> Form Trial Installation
                        </p>
                    </div>
                    <div class="col-md-6">
