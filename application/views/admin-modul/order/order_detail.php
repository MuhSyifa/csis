    ...
    <div id="content">
        <div class="panel box-shadow-none content-header">
            <div class="panel-body">
                <div class="col-md-12">
                  <div class="col-md-6">
                    <h3 class="animated fadeInLeft">Detail Installation</h3>
                        <p class="animated fadeInDown">
                            <a href="<?= base_url('dashboard');?>">CSIS</a> <span class="fa-angle-right fa"> </span>
                            <a href="<?php echo base_url('order/order_list'); ?>">Install</a> <span class="fa-angle-right fa"></span> Detail Install
                        </p>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="panel form-element-padding">
                      ...
                      <div class="modal-footer">
                            <a href="<?= base_url('order/order_list');?>" type="button" class="btn btn-default" >Back</a>
                      </div>
                        </div>
                    </div>
                </div>
